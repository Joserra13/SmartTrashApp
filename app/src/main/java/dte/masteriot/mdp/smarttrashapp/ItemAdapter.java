...
public class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    private final List<dte.masteriot.mdp.smarttrashapp.Item> myListOfItems;
    private final ItemViewHolder.ItemClickListener myClickListener;

    public ItemAdapter(List<dte.masteriot.mdp.smarttrashapp.Item> listOfItems, ItemViewHolder.ItemClickListener clickListener) {
        super();
